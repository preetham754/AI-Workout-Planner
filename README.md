...
**Input form** — set your goal, level, equipment, and time:
![Input form](screenshots/input-form.png)

**Retrieval step** — matched exercises shown before generation, so you can see exactly what the model was grounded in:
![Matched exercises](screenshots/matched-exercises.png)

**Generated plan** — streamed live from the local LLM:
